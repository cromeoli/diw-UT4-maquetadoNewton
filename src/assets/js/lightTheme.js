...
let logoNewton = document.getElementById("")
let inputbar1 = document.getElementById("inputBar1")
...
let resultArea = document.getElementById('backgroundResultArea')
let mainBackground = document.querySelector("body")

checkbox.addEventListener('change', function (){
    if (this.checked) {
        mainBackground.classList.add('')
